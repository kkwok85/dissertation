...
foreach yvariable in  drink_days_v2_w drink_amount_w total_drink_per_year_w ///
how_many_days_smoke_w how_many_cigarettes_w total_smoke_a_month_w ///
ever_marijuana_30_w ever_all_but_m_drugs_w ///
BMI_zscore_w overweight_w obese_w  exercise_for_weight_w diet_for_weight_w vege_fruits_dum_w  {
...
outreg2 using `yvariable', ctitle("No control") tex excel  nocons nor2 title("Table: `yvariable'")  keep(res_mom_work_hours_v2_w zConscientiousness_w1 zNeuroticism_w1 zExtraversion_w1  int_zConscientiousness_w1 int_zNeuroticism_w1 int_zExtraversion_w1 )    replace  label
...
outreg2 using `yvariable', ctitle("Add All") tex excel  nocons nor2 keep(res_mom_work_hours_v2_w zConscientiousness_w1 zNeuroticism_w1 zExtraversion_w1  int_zConscientiousness_w1 int_zNeuroticism_w1 int_zExtraversion_w1 ) append label
...
outreg2 using `yvariable', ctitle("Individual FE") tex excel  nocons nor2 keep(res_mom_work_hours_v2_w zConscientiousness_w1 zNeuroticism_w1 zExtraversion_w1  int_zConscientiousness_w1 int_zNeuroticism_w1 int_zExtraversion_w1) append label
...
/*
reg drink_days_v2_w 
i.dwh_impute_indicator_w /// 
i.dwh_impute_indicator_w ///  
c.res_mom_work_hours_v2_w##c.zConscientiousness_w1 
c.res_mom_work_hours_v2_w##c.zNeuroticism_w1 
c.res_mom_work_hours_v2_w##c.zExtraversion_w1  
i.mwh_impute_indicator_w ///
c.zConscientiousness_w1##c.res_dad_work_hours_v2_w 
c.zNeuroticism_w1##c.res_dad_work_hours_v2_w
c.zExtraversion_w1##c.res_dad_work_hours_v2_w 
i.dwh_impute_indicator_w ///
c.zConscientiousness_w1##c.age_w
c.zConscientiousness_w1##i.BIO_SEX
c.zConscientiousness_w1##i.race 
c.zConscientiousness_w1##c.num_siblings_w 
c.zConscientiousness_w1##c.AH_PVT
c.zConscientiousness_w1##i.no_mom_w 
c.zConscientiousness_w1##i.no_dad_w 
c.zConscientiousness_w1##c.age_mom_w 
c.zConscientiousness_w1##c.age_dad_w	///
c.zConscientiousness_w1##i.res_mom_occupation_w	///
c.zConscientiousness_w1##i.res_mom_educ_w 
i.mom_edu_impute_indicator_w ///
c.zConscientiousness_w1##i.res_dad_occupation_w 
c.zConscientiousness_w1##i.res_dad_educ_w 
i.dad_edu_impute_indicator_w ///
c.zConscientiousness_w1##c.family_income_1994 
i.fam_income_impute_ind ///
c.zConscientiousness_w1##i.month_year_w	 ///
c.zNeuroticism_w1##c.age_w 
c.zNeuroticism_w1##i.BIO_SEX 
c.zNeuroticism_w1##i.race 
c.zNeuroticism_w1##c.num_siblings_w 
c.zNeuroticism_w1##c.AH_PVT 
c.zNeuroticism_w1##i.no_mom_w 
c.zNeuroticism_w1##i.no_dad_w 
c.zNeuroticism_w1##c.age_mom_w 
c.zNeuroticism_w1##c.age_dad_w ///
c.zNeuroticism_w1##i.res_mom_occupation_w ///
c.zNeuroticism_w1##i.res_mom_educ_w 
i.mom_edu_impute_indicator_w ///
c.zNeuroticism_w1##i.res_dad_occupation_w 
c.zNeuroticism_w1##i.res_dad_educ_w 
i.dad_edu_impute_indicator_w ///
c.zNeuroticism_w1##c.family_income_1994 
i.fam_income_impute_ind ///
c.zNeuroticism_w1##i.month_year_w	 ///
c.zExtraversion_w1##c.age_w 
c.zExtraversion_w1##i.BIO_SEX 
c.zExtraversion_w1##i.race 
c.zExtraversion_w1##c.num_siblings_w 
c.zExtraversion_w1##c.AH_PVT
c.zExtraversion_w1##i.no_mom_w 
c.zExtraversion_w1##i.no_dad_w 
c.zExtraversion_w1##c.age_mom_w 
c.zExtraversion_w1##c.age_dad_w  ///
c.zExtraversion_w1##i.res_mom_occupation_w  ///
c.zExtraversion_w1##i.res_mom_educ_w 
i.mom_edu_impute_indicator_w ///
c.zExtraversion_w1##i.res_dad_occupation_w 
c.zExtraversion_w1##i.res_dad_educ_w 
i.dad_edu_impute_indicator_w ///
c.zExtraversion_w1##c.family_income_1994 
i.fam_income_impute_ind ///
c.zExtraversion_w1##i.month_year_w	///
[pw=GSWGT], vce(cluster PSUSCID_w)


areg drink_days_v2_w  c.res_mom_work_hours_v2_w##c.zConscientiousness_w1 c.res_mom_work_hours_v2_w##c.zNeuroticism_w1 c.res_mom_work_hours_v2_w##c.zExtraversion_w1  i.mwh_impute_indicator_w ///
c.zConscientiousness_w1##c.res_dad_work_hours_v2_w  c.zNeuroticism_w1##c.res_dad_work_hours_v2_w c.zExtraversion_w1##c.res_dad_work_hours_v2_w  i.dwh_impute_indicator_w ///
c.zConscientiousness_w1##c.age_w c.zConscientiousness_w1##i.BIO_SEX c.zConscientiousness_w1##i.race c.zConscientiousness_w1##c.num_siblings_w c.zConscientiousness_w1##c.AH_PVT c.zConscientiousness_w1##i.no_mom_w c.zConscientiousness_w1##i.no_dad_w c.zConscientiousness_w1##c.age_mom_w c.zConscientiousness_w1##c.age_dad_w	///
c.zConscientiousness_w1##i.res_mom_occupation_w	///
c.zConscientiousness_w1##i.res_mom_educ_w i.mom_edu_impute_indicator_w ///
