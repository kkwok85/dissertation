...
combine.data.regress.female.employ$children.sick.indicator <- 0
combine.data.regress.female.employ$children.sick.indicator <- combine.data.regress.female.employ$[which(combine.data.regress.female.employ$provide.medical.care.hh.children > 0 | combine.data.regress.female.employ$obtain.medical.care.hh.children
 
combine.data.regress.male.employ <- combine.data.regress.male.employ 


combine.data.regress.v2$portion.sec.child.care <- combine.data.regress.v2$sec.child.care/(combine.data.regress.v2$sec.child.care + combine.data.regress.v2$total.time.child)

combine.data.regress.v2$portion.primary.child.care <- combine.data.regress.v2$total.time.child/(combine.data.regress.v2$sec.child.care + combine.data.regress.v2$total.time.child)
...
a <- combine.data.regress.v2[which(combine.data.regress.v2$class.worker==6| combine.data.regress.v2$class.worker == 7 | combine.data.regress.v2$class.worker == 8),]
b <- combine.data.regress.v2[which(combine.data.regress.v2$class.worker==1 | combine.data.regress.v2$class.worker == 2 | combine.data.regress.v2$class.worker == 3 | combine.data.regress.v2$class.worker == 4 |  combine.data.regress.v2$class.worker == 5 ),]


summary( lm(paste0( "edited.spouse.work.hours"," ~ factor(wfh.v3)", demographic.no.sex.var ,employ.var, current.sit,family.bus, family.var, time.var, location.var, family.inc.var,  childcare.service.var, children.sick.var  ), data = combine.data.regress.v2[which(combine.data.regress.v2$class.worker==6| combine.data.regress.v2$class.worker == 7 | combine.data.regress.v2$class.worker == 8),] , weights = tufnwgtp ) )
