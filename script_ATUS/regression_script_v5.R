...
names.y <- c("Physical care", 
             ...
             "Total time for primary child care", "Total time for secondary child care*", "Total time for primary and secondary child care*" , "Travel time to and from work", "Total grooming time", "Total other time use" )
...
yvariables.v3 <-c( "physical.care.hh.children",
                   ...
                   "total.time.child", "sec.child.care.hh", "total.time.child.prim.sec",   "total.travel.work.time",  "total.grooming.time", "other.time.use" )
