...
stargazer(result[[1]], result[[2]],result[[3]], result[[4]], result[[5]], result[[6]], result[[7]],
          ...
          notes = "Sampling weights are applied and robust standard errors are used. Base category is working at other places such as workplace", notes.align = "l", omit.table.layout = "s" )
